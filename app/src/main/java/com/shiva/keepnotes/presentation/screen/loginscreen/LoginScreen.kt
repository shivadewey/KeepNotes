package com.shiva.keepnotes.presentation.screen.loginscreen
...
import com.shiva.keepnotes.data.auth.SignInState
        ...
        Column(
            ...
            Image(
                painter = rememberAsyncImagePainter(
                    ImageRequest.Builder(context).data(data = R.drawable.note_logo).apply(block = {
                        size(Size.ORIGINAL)
